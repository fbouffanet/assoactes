...
if (isset($_GET['idf_reg']) && isset($_GET['type_releve'])  && isset ($_GET['idf_acte']))
{
  ...
  {
    case 'C':
      $st_requete = "delete from  `indexation_acte_couple` where idf_registre=$i_idf_registre and idf_acte=$i_idf_acte"; 
    break;
    case 'P':
      $st_requete = "delete from  `indexation_acte_personne` where idf_registre=$i_idf_registre and idf_acte=$i_idf_acte";
    break;
    default:
