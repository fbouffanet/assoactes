...
{  
  ...
  $st_requete = "select vp1.idf_groupe,vp1.libelle from variantes_prenom vp1 join variantes_prenom vp2 on (vp1.idf_groupe=vp2.idf_groupe) where vp2.`libelle` COLLATE latin1_general_cs like :recherche order by libelle";
...
if ($i_nb_resultats==1)
{
  ...
  $a_retour['variantes']=$a_valeurs[0];
}
