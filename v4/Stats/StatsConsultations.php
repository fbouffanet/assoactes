...
switch ($gst_tri) {
  case 'NAI': $st_tri_sql = ' order by nb_naissances desc';break;
  case 'MAR': $st_tri_sql = ' order by nb_mariages desc';break;
  case 'DEC': $st_tri_sql = ' order by nb_deces desc';break;
  case 'CM': $st_tri_sql = ' order by nb_cm desc';break;
  case 'TOT': 
  default: $st_tri_sql = ' order by total desc'; 
}
...
print("<div class=SOUSTITRE>Demandes de l'ann&eacute;e courante par adh&eacute;rent (50 premiers) </div><br>");
if (count($a_ddes_adht)>0)
{
   print("<table border=1 align='center'>\n");
   print("<tr><th>Adh&eacute;</th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=TOT\">Total</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=NAI\">Ddes naissances</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=MAR\">Ddes mariages</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=DEC\">Ddes d&eacute;c&eacute;s</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=CM\">Ddes CM</a></th></tr>\n");
...
print("<div class=SOUSTITRE>Nombres de demandes des 30 derniers jours </div><br>");

if (count($a_ddes_jours)>0)
{
   print("<table border=1 align='center'>\n");
   print("<tr><th>Jour</th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=TOT\">Total</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=NAI\">Ddes naissances</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=MAR\">Ddes mariages</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=DEC\">Ddes d&eacute;c&eacute;s</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=CM\">Ddes CM</a></th></tr>\n");
   $f_moyenne_tot = 0;
   $f_moyenne_nai = 0;
   $f_moyenne_mar = 0;
   $f_moyenne_dec = 0;
...
print("<div class=SOUSTITRE>Demandes de l'ann&eacute;e courante par canton (30 premiers) </div><br>");
if (count($a_ddes_canton)>0)
{
   print("<table border=1 align='center'>\n");
   print("<tr><th>Canton</th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=TOT\">Total</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=NAI\">Ddes naissances</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=MAR\">Ddes mariages</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=DEC\">Ddes d&eacute;c&eacute;s</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=CM\">Ddes CM</a></th></tr>\n");
...
print("<div class=SOUSTITRE>Demandes de l'ann&eacute;e courante par commune (30 premi&egrave;res) </div><br>");
if (count($a_ddes_communes)>0)
{
   print("<table border=1 align='center'>\n");
   print("<tr><th>Commune</th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=TOT\">Total</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=NAI\">Ddes naissances</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=MAR\">Ddes mariages</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=DEC\">Ddes d&eacute;c&eacute;s</a></th><th><a href=\"".$_SERVER['PHP_SELF']."?tri=CM\">Ddes CM</a></th></tr>\n");
