<?php
//http://127.0.0.1:8888/Saisie_CM.php
...
function VerifieChamps(Formulaire)
{
   ...
   {
      ListeErreurs += "La date du contrat doit être de la forme : JJ/MM/AAAA\n";
   }
...
// Retourne la première lettre en majuscule et les autres en minuscule
...
function menu_liste($rconnexionBD)
{
   ...
   {        
      $pagination = new PaginationTableau($_SERVER['PHP_SELF'],'num_page',$rconnexionBD->nb_lignes(),NB_LIGNES_PAR_PAGE,DELTA_NAVIGATION,array('Nom époux','Prénom époux','Nom épouse','Prénom épouse','Date du contrat','Modifier'));
 ...
 * @param string $pst_ref_perso référence perso du document
 * @param string $pst_date_cm date du cm
 
 * @param string $pst_epx_nom nom de l'époux
 * @param string $pst_epx_prenom prénom de l'époux
 * @param string $pst_epx_prof profession de l'époux
 * @param string $pst_epx_nom_pere nom du père de l'époux
 * @param string $pst_epx_prenom_pere prénom du père de l'époux
 * @param string $pst_epx_prof_pere profession du père de l'époux
 * @param string $pst_epx_nom_mere nom de la mère de l'époux
 * @param string $pst_epx_prenom_mere prénom de la mère de l'époux
 * @param string $pst_epx_village village de l'époux
 * @param string $pst_epx_paroisse paroisse de l'époux
 * @param string $pst_epx_temoins témoins de l'époux
 
 * @param string $pst_epe_nom nom de l'épouse
 * @param string $pst_epe_prenom prénom de l'épouse
 * @param string $pst_epe_nom_pere nom du père de l'épouse
 * @param string $pst_epe_prenom_pere prénom du père de l'épouse
 * @param string $pst_epe_prof_pere profession du père de l'épouse
 * @param string $pst_epe_nom_mere nom de la mère de l'épouse
 * @param string $pst_epe_prenom_mere prénom de la mère de l'épouse
 * @param string $pst_epe_village village de l'épouse
 * @param string $pst_epe_paroisse paroisse de l'épouse
 * @param string $pst_epe_temoins témoins de l'épouse
 */ 
function menu_edition($pst_notaire,$pst_paroisse,$pst_cote,$pst_ref_perso,$pst_date_cm,$pst_epx_nom,$pst_epx_prenom,$pst_epx_prof,$pst_epx_nom_pere,$pst_epx_prenom_pere,$pst_epx_prof_pere,$pst_epx_nom_mere,
$pst_epx_prenom_mere,$pst_epx_village,$pst_epx_paroisse,$pst_epx_temoins,$pst_epe_nom,$pst_epe_prenom,$pst_epe_nom_pere,$pst_epe_prenom_pere,$pst_epe_prof_pere,$pst_epe_nom_mere,
$pst_epe_prenom_mere,$pst_epe_village,$pst_epe_paroisse,$pst_epe_temoins)
{
...
function menu_modifier($rconnexionBD,$pi_idf_contrats)
{
   ...
   list($st_notaire,$st_paroisse,$st_cote,$st_ref_perso,$st_date_cm,$st_epx_nom,$st_epx_prenom,$st_epx_prof,$st_epx_nom_pere,$st_epx_prenom_pere,$st_epx_prof_pere,$st_epx_nom_mere,
...
$st_epe_prenom_mere,$st_epe_village,$st_epe_paroisse,$st_epe_temoins)=$rconnexionBD->sql_select_liste($st_requete);
   ...
   menu_edition($st_notaire,$st_paroisse,$st_cote,$st_ref_perso,$st_date_cm,$st_epx_nom,$st_epx_prenom,$st_epx_prof,$st_epx_nom_pere,$st_epx_prenom_pere,$st_epx_prof_pere,$st_epx_nom_mere,
$st_epx_prenom_mere,$st_epx_village,$st_epx_paroisse,$st_epx_temoins,$st_epe_nom,$st_epe_prenom,$st_epe_nom_pere,$st_epe_prenom_pere,$st_epe_prof_pere,$st_epe_nom_mere,
