...
$ga_types_nimegue = array(IDF_NAISSANCE => 'Baptemes/Naissances',IDF_MARIAGE =>'Mariages', IDF_DECES => 'Sepultures/Deces', IDF_DIVERS=>'Divers(CM,...)');
