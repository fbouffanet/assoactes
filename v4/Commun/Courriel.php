...
class Courriel
{
	...
	*/
	...
	{ 
		require_once str_replace("/", DIRECTORY_SEPARATOR,"$pst_rep_site/PHPMailer/src/Exception.php");
		require_once str_replace("/", DIRECTORY_SEPARATOR,"$pst_rep_site/PHPMailer/src/SMTP.php");
		require_once str_replace("/", DIRECTORY_SEPARATOR,"$pst_rep_site/PHPMailer/src/PHPMailer.php");
