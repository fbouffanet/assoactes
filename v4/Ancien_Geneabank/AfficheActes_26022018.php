...
require_once('../v4/Commun/AffichageActe.php');
  ...
  if (isset($_SESSION['actes_gbk']))
  {
    ...
    { 
      ...
      switch ($i_idf_type_acte)
      {
         ...
         print("$st_commentaires\n");
         break;
         default:  ($st_description_acte,$st_permalien)=description_mariage_ou_divers($connexionBD,$a_type_acte,$a_profession,$a_commune_personne,$i_idf_acte);
