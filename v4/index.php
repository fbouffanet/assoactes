...
$(document).ready(function() {
    ...
    $("#idf_source_recherches_communes").select2({allowClear: true,placeholder: "Toutes"});
	$("#idf_type_acte_recherches_communes").select2({allowClear: true,placeholder: "Tous"});
	$("#idf_commune_recherches_communes").select2({allowClear: true,placeholder: "Toutes"});
    ...
    }, 'La commune doit être spéifiée quand le caractère joker ou ! est utilisé');
    ...
    $("#recherches_personne").validate({
        ...
        messages: {
            ...
            prenom: {
                required: "Le prénom est obligatoire si aucune commune/paroisse n'est s&eacute;lectionnée. Veuillez choisir une commune avec un rayon de recherche"
            }
        },
		errorElement: "em",
		errorPlacement: function ( error, element ) {
