...
$connexionBD->execute_requete($sqlcsv);
  ...
  $connexionBD->execute_requete("LOAD DATA INFILE '$st_tmp_file'  REPLACE INTO TABLE tmp_publication CHARACTER SET UTF8 FIELDS TERMINATED BY ';' LINES TERMINATED BY '\n'");// Je recharge la table publication avec le CSV
