...
//*********************************************************
	 ...
	 print('<div class="form-group col-md-4 col-md-offset-4"><input type="button" class="btn btn-primary">Création de la Publication</button> onClick="Exporte(0,\'EXPORTV3\')"/></div><br>');
   break;
