...
//*********************************************************
	 ...
	 print('<div class="form-group col-md-4 col-md-offset-4"><button type="button" class="btn btn-primary">"Création de la Publication"onClick="Exporte(0,\'EXPORTV3\')"/</button></div>');
   break;
