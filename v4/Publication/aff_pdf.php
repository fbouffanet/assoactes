...
function charge_csv(){
  ...
  data0 text COLLATE utf8 NOT NULL,
  data1 text COLLATE utf8 NOT NULL,
  data2 text COLLATE utf8 NOT NULL,
  data3 text COLLATE utf8 NOT NULL,
  data4 text COLLATE utf8 NOT NULL,
  data5 text COLLATE utf8 NOT NULL,
  data6 text COLLATE utf8 NOT NULL,
  data7 text COLLATE utf8 NOT NULL,
  data8 text COLLATE utf8 NOT NULL,
  data9 text COLLATE utf8 NOT NULL,
  data10 text COLLATE utf8 NOT NULL,
  data11 text COLLATE utf8 NOT NULL,
  data12 text COLLATE utf8 NOT NULL,
  data13 text COLLATE utf8 NOT NULL,
  data14 text COLLATE utf8 NOT NULL,
  data15 text COLLATE utf8 NOT NULL,
  data16 text COLLATE utf8 NOT NULL,
  data17 text COLLATE utf8 NOT NULL,
  data18 text COLLATE utf8 NOT NULL,
  data19 text COLLATE utf8 NOT NULL,
  data20 text COLLATE utf8 NOT NULL,
  data21 text COLLATE utf8 NOT NULL,
  data22 text COLLATE utf8 NOT NULL,
  data23 text COLLATE utf8 NOT NULL,
  data24 text COLLATE utf8 NOT NULL,
  data25 text COLLATE utf8 NOT NULL,
  data26 text COLLATE utf8 NOT NULL,
  data27 text COLLATE utf8 NOT NULL,
  data28 text COLLATE utf8 NOT NULL,
  data29 text COLLATE utf8 NOT NULL,
  data30 text COLLATE utf8 NOT NULL,
  data31 text COLLATE utf8 NOT NULL,
  data32 text COLLATE utf8 NOT NULL,
  data33 text COLLATE utf8 NOT NULL,
  data34 text COLLATE utf8 NOT NULL,
  data35 text COLLATE utf8 NOT NULL,
  data36 text COLLATE utf8 NOT NULL,
  data37 text COLLATE utf8 NOT NULL,
  data38 text COLLATE utf8 NOT NULL,
  data39 text COLLATE utf8 NOT NULL,
  data40 text COLLATE utf8 NOT NULL,
  data41 text COLLATE utf8 NOT NULL,
  data42 text COLLATE utf8 NOT NULL,
  data43 text COLLATE utf8 NOT NULL,
  data44 text COLLATE utf8 NOT NULL,
  data45 text COLLATE utf8 NOT NULL,
  data46 text COLLATE utf8 NOT NULL,
  data47 text COLLATE utf8 NOT NULL,
  data48 text COLLATE utf8 NOT NULL,
  data49 text COLLATE utf8 NOT NULL,
  data50 text COLLATE utf8 NOT NULL,
  data51 text COLLATE utf8 NOT NULL,
  data52 text COLLATE utf8 NOT NULL,
  data53 text COLLATE utf8 NOT NULL,
  data54 text COLLATE utf8 NOT NULL,
  data55 text COLLATE utf8 NOT NULL,
  data56 text COLLATE utf8 NOT NULL,
  data57 text COLLATE utf8 NOT NULL,
  data58 text COLLATE utf8 NOT NULL,
  data59 text COLLATE utf8 NOT NULL,
  data60 text COLLATE utf8 NOT NULL,
  data61 text COLLATE utf8 NOT NULL,
  data62 text COLLATE utf8 NOT NULL,
  data63 text COLLATE utf8 NOT NULL,
  data64 text COLLATE utf8 NOT NULL,
  data65 text COLLATE utf8 NOT NULL,
  data66 text COLLATE utf8 NOT NULL,
  data67 text COLLATE utf8 NOT NULL,
  data68 text COLLATE utf8 NOT NULL,
  data69 text COLLATE utf8 NOT NULL,
  data70 text COLLATE utf8 NOT NULL
) ENGINE=CSV DEFAULT CHARSET=latin1 COLLATE=utf8"; 
...
while ($data=$connexionBD->ligne_suivante_resultat($req))
   ...
   case "N":// $type_actes_nimegue = N
	...
	$l1='';
  	if (empty($data[14])){} else {$l1= $l1."  - ".utf8_decode("Père   ").$data[14]."   ".$data[15]."   ".$data[16]."   ".$data[17]."\n";}
  	if (empty($data[18])){} else {$l1= $l1."  - ".utf8_decode("Mère   ").$data[18]."   ".$data[19]."   ".$data[20]."   ".$data[21]."\n";}
 	if (empty($data[22])){} else {$l1= $l1."  - ".utf8_decode("Par/Tém1   ").$data[22]."   ".$data[23]."   ".$data[24]."\n";}
  	if (empty($data[25])){} else {$l1= $l1."  - ".utf8_decode("Mar/Tém2   ").$data[25]."   ".$data[26]."   ".$data[27]."\n";}
   ...
   case "D":// $type_actes_nimegue = D
	...
	if ($data[13] !== "") {$datenaiss =utf8_decode("né(e) le : ").$data[13];} else {$datenaiss = "";}//$datenaiss = $data[data13]
	...
	if (empty($data[22])){} else {$l1= $l1."  - ".utf8_decode("Père   ").$data[22]."   ".$data[23]."   ".$data[24]."   ".$data[25]."\n";}
	if (empty($data[26])){} else {$l1= $l1."  - ".utf8_decode("Mère   ").$data[26]."   ".$data[27]."   ".$data[28]."   ".$data[29]."\n";}
	if (empty($data[30])){} else {$l1= $l1."  - ".utf8_decode("Tèm1   ").$data[30]."   ".$data[31]."   ".$data[32]."\n";}
	if (empty($data[33])){} else {$l1= $l1."  - ".utf8_decode("Tèm2   ").$data[33]."   ".$data[34]."   ".$data[35]."\n";}
