...
while ($data=$connexionBD->ligne_suivante_resultat($req))
   ...
   case "N":// $type_actes_nimegue = N
	...
	$l1='';
  	if (empty($data[14])){} else {$l1= $l1."  - ".utf8_encode("Père   ").$data[14]."   ".$data[15]."   ".$data[16]."   ".$data[17]."\n";}
  	if (empty($data[18])){} else {$l1= $l1."  - ".utf8_encode("Mère   ").$data[18]."   ".$data[19]."   ".$data[20]."   ".$data[21]."\n";}
 	if (empty($data[22])){} else {$l1= $l1."  - ".utf8_encode("Par/Tém1   ").$data[22]."   ".$data[23]."   ".$data[24]."\n";}
  	if (empty($data[25])){} else {$l1= $l1."  - ".utf8_encode("Mar/Tém2   ").$data[25]."   ".$data[26]."   ".$data[27]."\n";}
   ...
   case "D":// $type_actes_nimegue = D
	...
	if ($data[13] !== "") {$datenaiss =utf8_encode("né(e) le : ").$data[13];} else {$datenaiss = "";}//$datenaiss = $data[data13]
	...
	if (empty($data[22])){} else {$l1= $l1."  - ".utf8_encode("Père   ").$data[22]."   ".$data[23]."   ".$data[24]."   ".$data[25]."\n";}
	if (empty($data[26])){} else {$l1= $l1."  - ".utf8_encode("Mère   ").$data[26]."   ".$data[27]."   ".$data[28]."   ".$data[29]."\n";}
	if (empty($data[30])){} else {$l1= $l1."  - ".utf8_encode("Tèm1   ").$data[30]."   ".$data[31]."   ".$data[32]."\n";}
	if (empty($data[33])){} else {$l1= $l1."  - ".utf8_encode("Tèm2   ").$data[33]."   ".$data[34]."   ".$data[35]."\n";}
  ...
  case "M":// $type_actes_nimegue = M
   ...
   // info epoux
	...
	//if ($data[data13]!=''or 0) {$datenaiss1 = "";} else {$datenaiss1 = utf8_encode(" né le : ").$data[data13]." ";}
	if ($data[13]!=''or empty($data[13])) {$datenaiss1 = "";} else {$datenaiss1 = utf8_encode(" né le : ").$data[13]." ";}//$datenaiss
	...
	if (empty($data[20])){} else {$l1= $l1."   - ".utf8_encode("Père  : ").$data[20]." ".$data[21]." ".$data[22]." ".$data[23]."\n ";}  
	if (empty($data[24])){} else {$l1= $l1."   - ".utf8_encode("Mère  : ").$data[24]." ".$data[25]." ".$data[26]." ".$data[27]." \n";} 
	
	//Info Epouse
	if (empty($data[30])) {$lieuorigine2 = "";} else {$lieuorigine2 = " Originaire de ".$data[30]." ";}  //$lieuorigine
	if ($data[31]!=''or empty($data[31])) {$datenaiss2 = "";} else {$datenaiss2 =utf8_encode(" née le : ").$data[31]." ";}//$datenaiss 
	...
	if (empty($data[38])){} else {$l1= $l1."   - ".utf8_encode("Père  : ").$data[38]." ".$data[39]." ".$data[40]." ".$data[41]."\n";}  
	if (empty($data[42])){} else {$l1= $l1."   - ".utf8_encode("Mère  : ").$data[42]." ".$data[43]." ".$data[44]." ".$data[45]."\n";} 
  	// Témoins
  	if (empty($data[46])){} else {$l1= $l1."    - ".utf8_encode("Témoin 1  : ").$data[46]." ".$data[47]." ".$data[48]."\n ";}  
	if (empty($data[49])){} else {$l1= $l1."    - ".utf8_encode("Témoin 2  : ").$data[49]." ".$data[50]." ".$data[51]."\n ";} 
  	if (empty($data[52])){} else {$l1= $l1."    - ".utf8_encode("Témoin 3  : ").$data[52]." ".$data[53]." ".$data[54]."\n ";}  
	if (empty($data[55])){} else {$l1= $l1."    - ".utf8_encode("Témoin 4  : ").$data[55]." ".$data[56]." ".$data[57]."\n ";} 
  ...
  case "V":// $type_actes_nimegue = V
   ...
   // info Intervenant1
	...
	if ($data[16]!=''or empty($data[16])) {$datenaiss1 = "";} else {$datenaiss1 =utf8_encode("né le : ").$data[16]." ";}//$datenaiss 
	...
	if (empty($info1)){} else {$l1= $l1."  - ".$info1."\n";}
	if (empty($commentaireEpx)){} else {$l1= $l1."  - ".$commentaireEpx."\n";}  
	if (empty($data[20])){} else {$l1= $l1."  - ".utf8_encode("Ex épouse : ").$data[20]." ".$data[21]." ".$data[22]."\n";}  
	if (empty($data[23])){} else {$l1= $l1."  - ".utf8_encode("Père  : ").$data[23]." ".$data[24]." ".$data[25]." ".$data[26]."\n";}  
	if (empty($data[27])){} else {$l1= $l1."  - ".utf8_encode("Mère  : ").$data[27]." ".$data[28]." ".$data[29]." ".$data[30]."\n";} 
	
	//Info Intervenant2
	if (empty($data[34])) {$lieuorigine2 = "";} else {$lieuorigine2 = "Originaire de ".$data[34]." ";}  //$lieuorigine
	if ($data[35]!=''or empty($data[35])) {$datenaiss2 = "";} else {$datenaiss2 =utf8_encode("née le : ").$data[35]." ";}//$datenaiss 
	...
	if (empty($commentaireEp)){} else {$l1= $l1."  - ".$commentaireEp."\n";}  
	if (empty($data[39])){} else {$l1= $l1."  - ".utf8_encode("Ex époux : ").$data[39]." ".$data[40]." ".$data[41]."\n";}  
	if (empty($data[42])){} else {$l1= $l1."  - ".utf8_encode("Père  : ").$data[42]." ".$data[43]." ".$data[45]." ".$data[44]."\n";}  
	if (empty($data[46])){} else {$l1= $l1."  - ".utf8_encode("Mère  : ").$data[46]." ".$data[47]." ".$data[49]." ".$data[48]."\n";} 
  	
  	// Témoins
  	if (empty($data[50])){} else {$l1= $l1."\n"."  - ".utf8_encode("Témoin 1  : ").$data[50]." ".$data[51]."  ".$data[52]."\n";} 
	if (empty($data[53])){} else {$l1= $l1."  - ".utf8_encode("Témoin 2  : ").$data[53]." ".$data[54]."  ".$data[55]."\n";}  
	if (empty($data[56])){} else {$l1= $l1."  - ".utf8_encode("Témoin 3  : ").$data[56]." ".$data[57]."  ".$data[58]."\n";} 
  	if (empty($data[59])){} else {$l1= $l1."  - ".utf8_encode("Témoin 4  : ").$data[59]." ".$data[60]."  ".$data[61]."\n";}  
