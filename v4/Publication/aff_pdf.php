...
function charge_csv(){
  ...
  data61 text  NOT NULL,
  data62 text  NOT NULL,
  data63 text  NOT NULL,
  data64 text  NOT NULL,
  data65 text  NOT NULL,
  data66 text  NOT NULL,
  data67 text  NOT NULL,
      ...
      if ($ligne == 2)
       {
           ...
           $pdf->Cell(0,10,"  ".utf8_encode($commune),0,1,'C');//Nom de la commune
