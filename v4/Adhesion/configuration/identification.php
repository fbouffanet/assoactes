<?php
  //HOMOLOGATION
  DEFINE( 'MERCHANT_ID', '49941014591194' ); // Merchant ID
  //PRODUCTION
  //DEFINE( 'MERCHANT_ID', '60291817202228' ); // Merchant ID
  
  //HOMOLOGATION
  DEFINE( 'ACCESS_KEY', 'hZYiqSiP3C7F0srHFpCc' ); // Certificate key
  //PRODUCTION
  //DEFINE( 'ACCESS_KEY', 'drwO5szPyOVfskyaOTuf' ); // Certificate key
