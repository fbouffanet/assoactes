...
//print("<link href='RechercheSommaire.css' type='text/css' rel='stylesheet'>");
...
//      $st_requete = "select numero, moisannee, rubrique from `sommaire` where auteur = '$auteur' and type = '$type'";
   ...
   print("<div class=TITRE>$titre</p></div>");
...
{
    print("<br>");
	print("<div class=TITRE>Recherche sur le sommaire des bulletins</div></p>");
     print("<br><br><div id='sommaire'>");
      print("<form action=\"".$_SERVER['PHP_SELF']."\" method=\"post\">");  
		print("<div class='cadre_rech'>");
			print("<p><input class='droites' type=submit value='Recherche' name='valide_rub'></p>");  
      ...
      print("<form action=\"".$_SERVER['PHP_SELF']."\" method=\"post\">"); 
		print("<div class='cadre_rech'>");
			print("<p><input class='droites' type=submit value='Recherche' name='valide_art'></p>");  
      ...
      print("<form action=\"".$_SERVER['PHP_SELF']."\" method=\"post\">"); 
		print("<div class='cadre_rech'>");
			print("<p><input class='droites' type=submit value='Recherche' name='valide_fam'></p>");  
      ...
      print("<form action=\"".$_SERVER['PHP_SELF']."\" method=\"post\">"); 
		print("<div class='cadre_rech'>");
			print("<p><input class='droites' type=submit value='Recherche' name='valide_asc'></p>");  
      ...
      print("<form action=\"".$_SERVER['PHP_SELF']."\" method=\"post\">"); 
		print("<div class='cadre_rech'>");
			print("<p><input class='droites' type=submit value='Recherche' name='valide_des'></p>");  
      ...
      print("<form action=\"".$_SERVER['PHP_SELF']."\" method=\"post\">");
		print("<div class='cadre_rech'>");
			print("<p><input class='droites' type=submit value='Recherche' name='valide_cou'></p>");  
