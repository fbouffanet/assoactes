					  ...
					  $pi_liasse_consult, $pi_idf_forme_liasse, $pa_formes_liasses, $pst_info_compl, $pst_mode)
{
	...
	if( $pst_mode == 'M' ) {
		print("<div class=\"form-row col-md-12\"><div class=\"form-group col-md-4\"><label class=\"col-form-label\" align=right>Cote de la liasse&nbsp</label></div>".
					"<div class=\"form-group col-md-1\"><div class=\"input-group\"><span class=\"input-group-addon\" align=left>$pst_cote</span></div></div></div>");
		print("<div class=\"form-row col-md-12\"><div class=\"form-group col-md-4\"><label class=\"col-form-label\" align=right>Période(s)&nbsp</label></div>".
					"<div class=\"form-group col-md-3\"><div class=\"input-group\"><span class=\"input-group-addon\" align=left>$pst_periodes</span></div></div>".
		...
		print("<div class=\"form-row col-md-12\"><div class=\"form-group col-md-4\"><label class=\"col-form-label\" align=right>Notaire(s)&nbsp</label></div>".
					"<div class=\"form-group col-md-3\"><div class=\"input-group\"><span class=\"input-group-addon\" align=left>$pst_notaires</span></div></div>".
