...
//$csv  = str_replace("&eacute;", "̩", $_SESSION['pdf']['titre'])."\n";
$csv  = $_SESSION['pdf']['titre']."\n";
$csv .= $_SESSION['pdf']['sous_titre']."\n";
if( $_SESSION['menu_rla'] != 'publication' ) 
	$csv .= $_SESSION['pdf']['nb_liasse']." liasses;".$_SESSION['pdf']['pourc_liste']." % de la liste;".$_SESSION['pdf']['pourc_tot']." % de la s̩rie\n";
