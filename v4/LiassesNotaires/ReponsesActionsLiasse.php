...
switch( $_SESSION['menu_rla'] ) {
	...
	case 'photo':
		...
		if( $_SESSION['sans_date_photo_rla'] == 'oui' ) {
...
if ($i_nb_ligne_extr>0)
{
	...
	if( $_SESSION['menu_rla'] == 'publication' ) {
		...
		// remplacement de DELTA_NAVIGATION par 10
		$pagination = new PaginationTableau($_SERVER['PHP_SELF'],'num_page',count($a_tableau),NB_LIGNES_PAR_PAGE,10,
