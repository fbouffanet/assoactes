...
function menu_liste_periode($pconnexionBD, $pst_cote_liasse)
{
	...
	print('<button type=submit name=btAjouterPeriode id=btAjouterPeriodeclass="btn btn-sm btn-success"><span class="glyphicon glyphicon-new-window"></span> Ajouter une période</button>');
