...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                    ...
                    <td width="629">
                        ...
                        <p>&nbsp;</p>
                        <h2>Nos adhérents sur Geneanet</h2>
                        <p>&nbsp;</p>
...
$st_requete = "select nom,prenom,site from adherent where site regexp 'http://gw[0-9]*.geneanet.org' and annee_cotisation=YEAR(NOW()) order by nom, prenom";
...
foreach ($a_adherents as $a_adherent)
{
   ...
   preg_match("(http://gw[0-9]*.geneanet.org/[a-zA-Z0-9\./\?\=]+)",$st_site,$a_matches);
   $st_site = $a_matches[0];
