...
print('<div class="form-group col-md-6"><label for="idf_source_recherches_communes">Source:</label><select name="idf_source_recherches_communes" id="idf_source_recherches_communes" class="js-select-avec-recherche form-control">');
$a_sources[0] = 'Toutes';
print(chaine_select_options($gi_idf_source,$a_sources));
print('</select></div>');

print('<div class="form-group col-md-6"><label for="idf_type_acte_recherches_communes">Type d\'acte:</label><select name="idf_type_acte_recherches_communes" id="idf_type_acte_recherches_communes" class="js-select-avec-recherche form-control">');
$a_types_acte[0] = 'Tous';
...
print("<span class=\"input-group-addon\">Actes</span><select id=\"releve_type_communes\" name=\"releve_type_communes\"class=\"form-control\">");
...
print("<span class=\"input-group-addon\">entre</span><select id=\"releve_mois_min_communes\" name=\"releve_mois_min_communes\" class=\"form-control\">");
for($i = 1; $i <= 12; $i++){
	$mois[$i] = str_pad($i, 2, '0', STR_PAD_LEFT);
}
$a_mois = array(''=>'Mois')+$mois;
print(chaine_select_options($gst_releve_mois_min,$a_mois));
print("</select><input type=\"text\" name=\"releve_annee_min_communes\" id=\"releve_annee_min_communes\" size=\"4\" maxlength=\"4\" value=\"$gst_releve_annee_min\" class=\"form-control\"><span class=\"input-group-addon\">et</span><select id=\"releve_mois_max_communes\" name=\"releve_mois_max_communes\" data-max=\"" . date('n') . "\" class=\"form-control\">");
print(chaine_select_options($gst_releve_mois_max,$a_mois));
print("</select><input type=\"text\" name=\"releve_annee_max_communes\" id=\"releve_annee_max_communes\" size=\"4\" maxlength=\"4\" value=\"$gst_releve_annee_max\" data-max=\"" . date('Y') . "\" class=\"form-control\" >");
print("</div>");
print("</div>");
...
print('</div>');
print('<div class="form-check col-md-4" class="form-check-label">');
...
print('<label for="variantes_epse" class="form-check-input">Recherche par variantes connues</label>');
print('</div>');
print('</div>');
...
print('<input type=button value="Effacer tous les Champs" name="raz" class="btn btn-warning raz"></div> ');
print('</div>');
print('</div>');
print("</form>");
print('</div>');
