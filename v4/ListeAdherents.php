   ...
   {                
      ...
      {  
         ...
         foreach ($a_liste_adherents as $a_adherent)
         {
            ...
            $a_tableau_modification[] = array($st_adherent,$st_ident_adh,$st_email_adh,$st_derniere_connexion_adh,$st_statut_adh,"<a id=\"$i_idf_adh\" href=\"".$_SERVER['PHP_SELF']."?mod=$i_idf_adh\" type=\"button\" class='btn btn-info'><span class=\"glyphicon glyphicon-edit\"></span> Modifier</a>","<div class=\"form-check\"><input type=checkbox name=\"supp[]\" id=\"$st_ident_adh\" value=$i_idf_adh class=\"form-check-input\"><label class=\"form-check-label sr-only\" for=\"$st_ident_adh\">A supprimer</label></div>","<a href='Stats/StatsAdht.php?idf_adherent=$i_idf_adh' target='_blank' class='btn btn-info lien_stats'><span class=\"glyphicon glyphicon-stats\"></span> Stats</a>","<a href='Stats/RecherchesAdht.php?idf_adherent=$i_idf_adh' target='_blank' class='btn btn-info lien_stats'><span class=\"glyphicon glyphicon-search\"></span> Recherches</a>");
         }
